...
#_________________Motion Detection using OpenCV____________________
...
time.sleep(2)
os.system('cls')
#https://github.com/shantnu/Webcam-Face-Detect/blob/master/webcam.py(Webcam-Face-Detect)
#https://github.com/diveshlunker/Railway-Reservation-System/blob/master/railway_reservation.py(Railway-Reservation-System)